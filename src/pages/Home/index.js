    ...
    return (
        <div>
            ...
            <Navbar className={"ml-3 mt-3"}>
                <Navbar.Brand href="#">Gather Fest</Navbar.Brand>
                <Navbar.Toggle/>
                        ...
                        >
                            <Card.Body>
                                ...
                                <div>
                                    ...
                                    <NumberFormat value={150000} thousandSeparator={true} prefix={"Rp "}
                                                  displayType={"text"} renderText={value => <span
                                        style={{fontSize: 14, color: "#FFF"}}>{value}</span>}/>
                                </div>
                                <Button
                    ...
                    >
                        ...
                        >
                            <Card.Body>
                                ...
                                <div>
                                    <BiDollarCircle style={{color: "#FFF"}}/>{" "}
                                    <NumberFormat value={50000} thousandSeparator={true} prefix={"Rp "}
                                                  displayType={"text"} renderText={value => <span
                                        style={{fontSize: 14, color: "#FFF"}}>{value}</span>}/>
                                </div>
                                <Button
                                    ...
                                    <Card.Body>
                                        ...
                                        <Card.Text>
                                            ...
                                            <div>
                                                ...
                                                <NumberFormat value={event.price} thousandSeparator={true}
                                                              prefix={"Rp "} displayType={"text"}
                                                              renderText={value => <span
                                                                  style={{fontSize: 14}}>{value}</span>}/>
                                            </div>
                                        </Card.Text>
                                        <Button
                                            variant="primary"
