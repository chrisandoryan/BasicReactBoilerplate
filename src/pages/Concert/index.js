                ...
                loading ? (
                    <Splash></Splash>
                        ...
                        <Row className={"fixed-bottom"}>
                            <Col ref={iframe} md={8}>
                                <iframe className={"game-frame"} src={event?.concert_link} frameBorder="0" onLoad={handleFrameLoading} allow="camera https://gather.town/; microphone https://gather.town/" allowfullscreen/>
                            </Col>
                            <Col md={2}>
                                <Card
